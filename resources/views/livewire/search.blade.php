<div class="w-1/2 relative" x-data="{open: false, searchTerm: @entangle('searchTerm')}">
  <x-jet-input type="text" wire:model.debounce.500ms="searchTerm" class="w-full" x-on:focus="open=true"
    x-on:blur="open=false" placeholder="Search" />
  <ul x-show="open && !!searchTerm" x-transition:enter="transition ease-out duration-150"
    ...
    @forelse ($articles as $article)
      <li class="py-2 border-b my-2 flex justify-between">
